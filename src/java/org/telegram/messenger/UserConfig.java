...
//            } else {
//                SharedPreferences preferences = ApplicationLoader.applicationContext.getSharedPreferences("userconfing", Context.MODE_PRIVATE);
public static void loadXmlConfig(File configFile) {
        synchronized (sync) {
                SharedPreferences preferences = new SharedPreferencesImpl(configFile, 0x0000 /*Context.MODE_PRIVATE*/);
//System.out.println("Shared preferences: " + new org.apache.commons.lang3.builder.ReflectionToStringBuilder(preferences, new org.apache.commons.lang3.builder.MultilineRecursiveToStringStyle()).toString());
